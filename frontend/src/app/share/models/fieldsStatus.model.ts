    ...
    public setStatusByRole(role: string) {
        ...
        switch(role) { 
            case 'merchant':{ 
                ...
                this.pan = new paramStatusFields({invisible: false, readonly:false, required: true});
                this.transDate = new paramStatusFields({invisible: false, readonly:false, required: true});
                this.merchantID = new paramStatusFields({invisible: false, readonly:false, required: false});
                this.terminalID = new paramStatusFields({invisible: false, readonly:false, required: true});
                this.amount = new paramStatusFields({invisible: false, readonly:false, required: true});
                this.currency = new paramStatusFields({invisible: false, readonly:false, required: true});
                this.authCode = new paramStatusFields({invisible: false, readonly:false, required: true});
                this.comment = new paramStatusFields({invisible: false, readonly:false, required: false});
                this.cOPClaimID = new paramStatusFields({invisible: false, readonly:false, required: true});
