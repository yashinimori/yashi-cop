...
from config.settings.base import MASTERCOM_CONSUMER_KEY, MASTERCOM_KEY, MASTERCOM_KEY_PASSWORD, MASTERCOM_KEY_ALIAS
...
def populate_db(claim_id, claim_details, queue_name, transaction_id, pan):
    from .models import Chargeback, ChargebackDetail
